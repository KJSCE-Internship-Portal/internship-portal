    ...
    <div>
      ...
      <div className="w-full h-screen flex items-start">
        <div className="relative w-1/2 h-full flex-col sm:block hidden">
          <img
            alt=""
            src={require("../../assets/images/login_cover.png")}
          ...
          <div className="bg-[#f5f5f5] flex flex-col p-20 items-center">
            ...
            <div className="w-full flex flex-col items-center pt-8 pb-4">
              ...
              <p className="text-sm mb-2 text-center">
                Please Login through Google to continue
              </p>
            </div>
            <button
              type="button"
              onClick={() => auth()}
              className="w-full text-[#060606] my-2 front-semibold bg-white border-2 border-black rounded-md p-4 text-center flex items-center justify-center"
            >
              <img
