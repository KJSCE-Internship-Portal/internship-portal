  ...
  return (
    <ChakraProvider theme={theme}>
      <Center className="min-h-screen bg-gray-100">
        <Box className="max-w-xl mx-auto px-6 py-2 border-2 border-gray-300 rounded-lg shadow-lg my-5 bg-white">          <BackButton />          <VStack spacing={3} align="stretch">
            {" "}
            {/* reduced spacing */}
            <Heading
              as="h1"
            ...
            {userDetails.map((detail, index) => (
              <Box key={index} p={3} className="border-t border-gray-200">
                {" "}
                {/* reduced padding */}
                <Activity
                  label={detail.label}
