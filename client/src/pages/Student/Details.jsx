...
const Details = () => {
  ...
  const MAX_OFFER_SIZE = 100 * 1024; // 100 KB
  const handleOfferChange = (e) => {
    const file = e.target.files[0];
    if (!file) return;
    if (file.size > MAX_OFFER_SIZE) {
      showToast(toast, "Error", "error", "Offer letter must be 100 KB or smaller.");
      e.target.value = "";
      setOfferLetter(null);
      return;
    }
    ...
    try {
      ...
      if (weeksDiff < 14) {
        showToast(
          ...
          "Error",
          "error",
          "Minimum internship duration should be 14 weeks."
        );
      ...
      formData.append("profile_picture_url", userInfo.imageUrl);
      formData.append("email", email);
      formData.append("sub_id", userInfo.sub_id);
      ...
      // Add internship data as JSON string
      const internshipData = {
        ...
        stipend_amount: stipendStatus === "paid" ? stipend : null,
        completion: [],
        progress: [],
      };
      formData.append("internships", JSON.stringify([internshipData]));
      
      // Append offer letter file if selected
      if (offerLetter) {
    ...
    >
      ...
      <div className="max-w-3xl mx-auto px-10 relative z-10">
        ...
        <div className="max-w-2xl mx-auto">
          <form
            className="w-full max-w-2xl mx-auto bg-white/90 p-6 rounded-lg shadow-lg"
            onSubmit={(e) => {
              e.preventDefault();
          ...
          >
            ...
            <div class="py-5 px-4 mb-3 bg-white rounded-lg rounded-t-lg dark:bg-gray-400 dark:border-gray-700">
              <label
                for="rollno"
                class="text-lg lg:text-2xl font-bold text-gray-900 dark:text-black"
              >
                Email<span class="text-red-500">*</span>
              </label>
              <input
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-500 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                type="email"
                name="email"
                value={email}
            ...
            <div className="flex flex-wrap justify-between">
              <div className="mr-4 flex-1 py-3 px-4 mb-4 bg-white rounded-lg rounded-t-lg dark:bg-gray-400 dark:border-gray-700">
                ...
                <select
                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-500 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 max-h-64 overflow-y-auto"
                  name="department"
                  value={department}
                ...
                >
                  ...
                  <option value="Robotics And Artificial Intelligence" hidden>
                    RAI
                  </option>
                  <option
                  ...
                  <option value="Computer And Communication Engineering" hidden>
                    CCE
                  </option>
                </select>
              </div>
              <div className="flex-1 py-3 px-4 mb-4 bg-white rounded-lg rounded-t-lg dark:bg-gray-400 dark:border-gray-700">
                <label
                  for="batch"
                  className="text-lg lg:text-2xl font-bold text-gray-900 dark:text-black"
                >
            ...
            <div className="flex flex-wrap justify-between">
              ...
              <div className="flex-1 py-3 px-4 mb-4 bg-white rounded-lg rounded-t-lg dark:bg-gray-400 dark:border-gray-700">
                <label
                  ...
                  className="text-lg lg:text-2xl font-bold text-gray-900 dark:text-black"
                >
                  Batch (Current Year)<span className="text-red-500">*</span>
                </label>
                <select
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-500 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  name="batch"
            ...
            <div class="py-5 px-4 mb-4 bg-white rounded-lg rounded-t-lg dark:bg-gray-400 dark:border-gray-700">
              <label class="text-lg lg:text-2xl font-bold text-gray-900 dark:text-black">
              ...
              <div className="mt-3 space-y-3">
                <div className="flex items-center">
                  <input
                    ...
                    name="internshipType"
                    value="case1"
                    checked={internshipType === "case1"}
                    onChange={(e) => setInternshipType(e.target.value)}
                    className="w-4 h-4 text-blue-600"
                    required
                  />
                  <label htmlFor="case1" className="ml-3 text-gray-900 dark:text-black">
                    Case 1
                  </label>
                </div>
                <div className="flex items-center">
                  <input
                    ...
                    name="internshipType"
                    value="case2"
                    checked={internshipType === "case2"}
                    onChange={(e) => setInternshipType(e.target.value)}
                    className="w-4 h-4 text-blue-600"
                    required
                  />
                  <label htmlFor="case2" className="ml-3 text-gray-900 dark:text-black">
                    Case 2
                  </label>
                </div>
              </div>
            ...
            <div class="py-5 px-4 mb-4 bg-white rounded-lg rounded-t-lg dark:bg-gray-400 dark:border-gray-700">
              <label
                ...
                class="text-lg lg:text-2xl font-bold text-gray-900 dark:text-black"
              >
                Company Mentor<span class="text-red-500">*</span>
              </label>
              <input
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-500 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                type="text"
            ...
            <div class="py-5 px-4 mb-4 bg-white rounded-lg rounded-t-lg dark:bg-gray-400 dark:border-gray-700">
              <label
                ...
                class="text-lg lg:text-2xl font-bold text-gray-900 dark:text-black"
              >
                Company Mentor Email<span class="text-red-500">*</span>
              </label>
              <input
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-500 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                type="email"
            ...
            <div class="py-5 px-4 mb-4 bg-white rounded-lg rounded-t-lg dark:bg-gray-400 dark:border-gray-700">
              <label class="text-lg lg:text-2xl font-bold text-gray-900 dark:text-black">
                Stipend Information<span class="text-red-500">*</span>
              </label>
              <div className="mt-3 space-y-3">
                <div className="flex items-center">
                  <input
                    ...
                    name="stipendStatus"
                    value="paid"
                    checked={stipendStatus === "paid"}
                    onChange={(e) => {
                      setStipendStatus(e.target.value);
                    ...
                    required
                  />
                  <label htmlFor="stipendPaid" className="ml-3 text-gray-900 dark:text-black">
                    Paid
                  </label>
                </div>
                <div className="flex items-center">
                  <input
                    ...
                    required
                  />
                  <label htmlFor="stipendUnpaid" className="ml-3 text-gray-900 dark:text-black">
                    Unpaid
                  </label>
                </div>
              </div>
            ...
            {stipendStatus === "paid" && (
              <div class="py-5 px-4 mb-4 bg-white rounded-lg rounded-t-lg dark:bg-gray-400 dark:border-gray-700">
                <label
                  ...
                  class="text-lg lg:text-2xl font-bold text-gray-900 dark:text-black"
                >
                  Stipend Amount (in ₹)<span class="text-red-500">*</span>
                </label>
                <input
                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-500 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  type="text"
