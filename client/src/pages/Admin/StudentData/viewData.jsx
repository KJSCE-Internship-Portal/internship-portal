...
const getEvaluation = (student, evalName) => {
  try {
    ...
    if (!entry) entry = evalName === "ISE" ? evaluations[0] : evaluations[1] || evaluations[0];
                  ...
                  return (
                    <React.Fragment key={student.email} id={student.rollno}>
                      ...
                      >
                        ...
                        <Td
                          style={{
                            color: student.internships[0].evaluation[0]
                              ?.is_signed
                              ? colors.primary
                              : colors.heading1,
                          }}
                        >
                          {student.internships[0].evaluation[0]?.is_signed
                            ? "Completed"
                            : "Pending"}
                        </Td>
                        ...
                        <Td
                          style={{
                            color: student.internships[0].evaluation[1]
                              ?.is_signed
                              ? colors.primary
                              : colors.heading1,
                          }}
                        >
                          {student.internships[0].evaluation[1]?.is_signed
                            ? "Completed"
                            : "Pending"}
                        </Td>
                      </HoverableTr>
