...
const StudentList = () => {
        ...
        <ModalContent>
          ...
          <ModalBody>
            ...
            >
              ...
              <option value="Artificial Intelligence And Data Science" hidden>
                AIDS
              </option>
          ...
          <ModalFooter>
            <ExportToExcelButton
              ...
              batch={selectBatch}
            />
            {/* PDF download removed for admin student list as per request */}
          </ModalFooter>
        </ModalContent>
      </Modal>
    );
              ...
              >
                <div className="flex flex-row justify-start w-full">
                  <Avatar
                    ...
                    className="h-8 w-8 mr-2 mt-0 mb-2"
                  ></Avatar>
                  <div className="flex flex-1 flex-col items-start justify-start w-full">
                    ...
                    <p className={`text-${colors.font} text-s w-full`}>
                      {student.email}
                    </p>
                  </div>
                </div>
  ...
  return (
    <div
      className={`bg-${colors.secondary2} flex flex-col font-roboto items-left justify-start mx-auto w-full max-h-full py-6 px-4 h-screen text-${colors.font}`}
    >
      {/* Back Button */}
      <BackButton to="/admin/dashboard" label="Back to home" />

      <div>
        <h1 className={`text-xl font-bold mb-5 text-${colors.font}`}>
          Students List{" "}
          <DownloadIcon
      ...
      <Tabs variant="soft-rounded" isFitted colorScheme="green">
        <TabList marginX={5} gap={3}>
          <Tab bg={colors.hover} color={colors.font}>
            COMPS
          </Tab>
          <Tab bg={colors.hover} color={colors.font}>
            IT
