...
// Importing scroll behavior
import { preventNumberInputScroll } from "./scrollissue/preventScroll.js";
...
function AppContent() {
  ...
  // scrolling behavior useEffect
  useEffect(() => {
    // Prevent scroll on number input fields
        ...
        >
          <Wrapper>
            <Routes>
              ...
              />
              <Route
                path="/coordinator/mentor/:id/students"
                element={<PrivateRoute element={<MentorPage />} />}
              />
              <Route
                path="/coordinator/:department/all-students"
                element={<PrivateRoute element={<AllStudentsInDepartment />} />}
              />
              <Route
                path="/admin/dashboard/viewstudent"
                element={<PrivateRoute element={<ViewStudent />} />}
              ></Route>
              <Route
                path="/admin/dashboard/viewmentor"
                element={<PrivateRoute element={<ViewMentor />} />}
              ></Route>
              <Route
                path="/admin/dashboard/viewcoordinator"
                element={<PrivateRoute element={<ViewCoord />} />}
              ></Route>
              {/* <Route
