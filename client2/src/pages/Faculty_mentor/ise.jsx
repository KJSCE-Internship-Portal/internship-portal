    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const data = {
                ...
                project_title: title,
                work_done: workdone,
                report_quality_marks: qreport,
                oral_presentation_marks: oral,
                work_quality_marks: qwork,
                work_understanding_marks: understanding,
                periodic_interaction_marks: interaction,
