...
const FramePage = () => {
  ...
  function generateWeekURL(weekNo) {
    ...
    if(currentDate > new Date(progressData[weekNo-1].startDate) && currentDate < new Date(progressData[weekNo-1].endDate)){
      if(progressData[weekNo-1].status == 'Not Submitted'){
